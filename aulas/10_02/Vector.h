...
public:
    ...
    // essa funcao possibilita atribuir um vector a outro e fazer uma copia automatica
    Vector& operator=(const Vector& v);

    // Compara vectors e retorna 'true' se, e somente se, eles forem identicos.
    // Dois vectors sao identicos se, e somente se, eles tem o mesmo numero de elementos e 
    // se os elementos correspondentes tem o mesmo valor.
